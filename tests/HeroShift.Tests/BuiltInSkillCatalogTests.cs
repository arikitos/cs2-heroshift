...
// Every built in skill must match the captured behavior baseline.
public class BuiltInSkillCatalogTests
{
    [Fact]
    public void BuildRegistry_RegistersEveryBuiltInSkillExactlyOnce()
    {
