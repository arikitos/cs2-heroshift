 ...
 *
 * Registration happens once at startup through BuiltInSkillCatalog. Lookups
 * are then pure dictionary reads with no reflection or assembly scanning.
 */
public sealed class SkillRegistry
{
    ...
    // skill for hooks only a subset implement.
