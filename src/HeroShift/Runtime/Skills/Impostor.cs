...
{
    /*
     * Impostor - You appear to be a member of the enemy team.
     *
     * LOGIC
     *   EnableSkill: swaps your model/team appearance.
     *   DisableSkill: restores the real appearance.
     *
    ...
    {
        private static readonly SkillId skillName = BuiltInSkillIds.Impostor;
