...
/*
 * Helpers for merging JSON overrides into typed defaults and reporting
 * unknown or mistyped fields with their JSON paths
 */
public static class JsonMerge
{
    // heroshift.json uses camelCase property names throughout (matching every
    // configuration uses camelCase keys such as "gameMode" and "cooldownSeconds", while the C#
