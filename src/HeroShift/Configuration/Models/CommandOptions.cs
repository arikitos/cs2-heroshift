 ...
 * permission. Aliases are arrays. The loader trims values, rejects empty
 * entries, and detects duplicates across commands.
 */
...
/*
 * Canonical command aliases and permission defaults.
 */
